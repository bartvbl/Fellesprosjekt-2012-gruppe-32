...
public class Main {
	public Main() {
		...
		CalendarView.calendarTable.setRowHeight(80);
		...
		new EditingHandler();
		CalendarView.favouritesList.setCellRenderer(new ItemRenderer());
		((DefaultListModel) CalendarView.favouritesList.getModel()).addElement("lol");
		((DefaultListModel) CalendarView.favouritesList.getModel()).addElement("lol");
		((DefaultListModel) CalendarView.favouritesList.getModel()).addElement("lol");
		((DefaultListModel) CalendarView.favouritesList.getModel()).addElement("lol");
		((DefaultListModel) CalendarView.favouritesList.getModel()).addElement("lol");
